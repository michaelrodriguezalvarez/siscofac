...
class Factura
{
    ...
    public function setNumeroRegistro(int $numeroRegistro): self
    {
    ...
    {
        return $this->numeroDelProveedor;
    }

    public function setNumeroDelProveedor(string $numeroDelProveedor): self
    {
        $this->numeroDelProveedor = $numeroDelProveedor;
